import { alterarImagem, atualizarProduto, deletarProduto, inserirProduto, listarCategoria, listarPorNome, listarProduto, login } from '../repository/adminRepository.js';
...
server.put('/admin/produto/:id/imagem', upload.single('produto'), async (req, resp) => {
    try{    
        if(!req.file){
